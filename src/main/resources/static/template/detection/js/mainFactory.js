...
(function () {
    ...
    leaflet.Marker = function (options) {
        ...
        var _init = function () {//初始化方法
            ...
            _isVisible = _options.isVisible || _isVisible;
        ...
        _self.setIsVisible = function (isVisible) {
            _isVisible = isVisible;
        };
        _self.getIsVisible = function () {
            return _isVisible;
        };
    ...
    leaflet.Map = function (options) {
        ...
        var _draw = function (objs) {
            ...
            for (var i in objs) {
                ...
                if (obj instanceof leaflet.Shape) {
                    if(marker.options.info.getIsVisible()){
        ...
        _self.readMain = function (params) {
